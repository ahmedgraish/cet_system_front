...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="160" height="140" viewBox="0 0 100 100">
        ...
        <path fill="#f9dbd2" d="M50 13A37 37 0 1 0 50 87A37 37 0 1 0 50 13Z"></path>
        ...
        <g>
            <path fill="#fdfcee" d="M50 26A24 24 0 1 0 50 74A24 24 0 1 0 50 26Z"></path>
            <path fill="#472b29"
            ...
            <path fill="#ee3e54" d="M50 30.4A19.6 19.6 0 1 0 50 69.6A19.6 19.6 0 1 0 50 30.4Z"></path>
            <path fill="#f06272"
