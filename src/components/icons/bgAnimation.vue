<template>
    <svg class="opacity-90" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
svg {
    ...
    background-image: linear-gradient(to bottom, rgba(135, 191, 231, 0.86), #0e4166);
}
</style>